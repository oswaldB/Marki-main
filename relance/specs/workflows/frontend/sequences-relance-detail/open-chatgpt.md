# Workflow : Générer avec ChatGPT

## Écran
`sequences-relance-detail.html`

## Élément déclencheur
Bouton avec `@click="openChatGpt(idx)"`

## Action
Ouvrir l'interface de génération IA

## Description
- Lance l'assistant ChatGPT
- Génère du contenu pour l'email
- Remplace ou complète le texte existant
