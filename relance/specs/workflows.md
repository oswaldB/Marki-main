...
| Workflow | Dossier spec | Description |
|----------|--------------|-------------|
| `calculer-kpis` | `specs/_app/backend/workflows/calculer-kpis/` | Calcule taux impayés, DSO depuis collections LokiJS |
| `get-top-debiteurs` | `specs/_app/backend/workflows/get-top-debiteurs/` | Requête collection impayés avec index payer_id |
...
| Méthode | Endpoint | Description |
|---------|----------|-------------|
| GET | `/api/dashboard/kpis` | KPIs calculés |
| GET | `/api/dashboard/top-debiteurs` | Top 10 débiteurs |
| GET | `/api/dashboard/evolution` | Données graphique 12 mois |
