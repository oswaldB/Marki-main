# Workflow : Fréquence quotidienne (PouchDB)

## Écran
`sequences-suivi-detail.html`

## Élément déclencheur
Bouton avec `@click="setFrequenceQuotidien(email)"`
...
export function setFrequenceQuotidien(email) {
