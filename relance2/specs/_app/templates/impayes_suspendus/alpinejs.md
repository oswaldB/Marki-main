# impayes_suspendus/alpinejs.md - Spécification Alpine.js

## Description

Initialisation Alpine.js pour la page "impayes_suspendus".
...
```javascript
// templates/impayes_suspendus/alpinejs.html
<script>
    const log = {
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('impayes_suspendus', () => ({
            ...
            // 2. INIT (EN PREMIER)
            // =====================================================
            {% include 'impayes_suspendus/workflows/initial-load.html' %},
...
- `mockups/impayes_suspendus.html` (si existe)
