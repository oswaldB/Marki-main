# portail_mission/alpinejs.md - Spécification Alpine.js

## Description

Initialisation Alpine.js pour la page "portail_mission".
...
```javascript
// templates/portail_mission/alpinejs.html
<script>
    const log = {
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('portail_mission', () => ({
            ...
            // 2. INIT (EN PREMIER)
            // =====================================================
            {% include 'portail_mission/workflows/initial-load.html' %},
...
- `mockups/portail_mission.html` (si existe)
