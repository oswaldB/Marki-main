# smart_marki/alpinejs.md - Spécification Alpine.js

## Description

Initialisation Alpine.js pour la page "smart_marki".
...
```javascript
// templates/smart_marki/alpinejs.html
<script>
    const log = {
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('smart_marki', () => ({
            ...
            // 2. INIT (EN PREMIER)
            // =====================================================
            {% include 'smart_marki/workflows/initial-load.html' %},
...
- `mockups/smart_marki.html` (si existe)
