# contacts/alpinejs.md - Spécification Alpine.js

## Description

Initialisation Alpine.js pour la page "contacts".
...
<script>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('contacts', () => ({
            ...
            // 2. INIT (EN PREMIER)
            // =====================================================
            {% include 'contacts/workflows/initial-load.html' %},
...
- `mockups/contacts.html` (si existe)
