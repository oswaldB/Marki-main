# impayes_detail/alpinejs.md - Spécification Alpine.js

## Description

Initialisation Alpine.js pour la page "impayes_detail".
...
```javascript
// templates/impayes_detail/alpinejs.html
<script>
    const log = {
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('impayes_detail', () => ({
            ...
            // 2. INIT (EN PREMIER)
            // =====================================================
            {% include 'impayes_detail/workflows/initial-load.html' %},
...
- `mockups/impayes_detail.html` (si existe)
