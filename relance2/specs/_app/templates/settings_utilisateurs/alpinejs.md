# settings_utilisateurs/alpinejs.md - Spécification Alpine.js

## Description

Initialisation Alpine.js pour la page "settings_utilisateurs".
...
```javascript
// templates/settings_utilisateurs/alpinejs.html
<script>
    const log = {
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('settings_utilisateurs', () => ({
            // =====================================================
            ...
            // 2. INIT (EN PREMIER)
            // =====================================================
            {% include 'settings_utilisateurs/workflows/initial-load.html' %},
...
- `mockups/settings_utilisateurs.html` (si existe)
