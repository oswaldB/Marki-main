# settings_smtp/alpinejs.md - Spécification Alpine.js

## Description

Initialisation Alpine.js pour la page "settings_smtp".
...
<script>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('settings_smtp', () => ({
            ...
            // 2. INIT (EN PREMIER)
            // =====================================================
            {% include 'settings_smtp/workflows/initial-load.html' %},
...
- `mockups/settings_smtp.html` (si existe)
