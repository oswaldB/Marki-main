# relances_detail/alpinejs.md - Spécification Alpine.js

## Description

Initialisation Alpine.js pour la page "relances_detail".
...
```javascript
// templates/relances_detail/alpinejs.html
<script>
    const log = {
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('relances_detail', () => ({
            ...
            // 2. INIT (EN PREMIER)
            // =====================================================
            {% include 'relances_detail/workflows/initial-load.html' %},
...
- `mockups/relances_detail.html` (si existe)
