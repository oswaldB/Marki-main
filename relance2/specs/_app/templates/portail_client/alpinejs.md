# portail_client/alpinejs.md - Spécification Alpine.js

## Description

Initialisation Alpine.js pour la page "portail_client".
...
```javascript
// templates/portail_client/alpinejs.html
<script>
    const log = {
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('portail_client', () => ({
            ...
            // 2. INIT (EN PREMIER)
            // =====================================================
            {% include 'portail_client/workflows/initial-load.html' %},
...
- `mockups/portail_client.html` (si existe)
