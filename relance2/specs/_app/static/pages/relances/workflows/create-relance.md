...
|------------|------------------------|
| `start` | `console.log('[WORKFLOW.relances-create-relance] START: Création d\'une nouvelle relance')` |
| `validation` | `console.log('[WORKFLOW.relances-create-relance] STEP: Validation du formulaire', { contact_id, sequence_id, impaye_ids })` |
| `api-call` | `console.log('[WORKFLOW.relances-create-relance] STEP: Appel API POST /api/relances', payload)` |
| `api-response` | `console.log('[WORKFLOW.relances-create-relance] DATA: Réponse API reçue', response)` |
| `state-updated` | `console.log('[WORKFLOW.relances-create-relance] STEP: relances[] mis à jour, showNewRelanceModal = false')` |
| `end` | `console.log('[WORKFLOW.relances-create-relance] SUCCESS: Relance créée en', duree, 'ms')` |
| `error` | `console.error('[WORKFLOW.relances-create-relance] ERROR:', error)` |
