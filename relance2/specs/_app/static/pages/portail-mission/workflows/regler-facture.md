...
|------------|------------------------|
| `start` | `console.log('[WORKFLOW.portail-mission-regler-facture] START: Réglement facture', this.impaye?.nfacture)` |
| `validation` | `console.log('[WORKFLOW.portail-mission-regler-facture] STEP: Validation configuration paiement disponible')` |
| `config-loaded` | `console.log('[WORKFLOW.portail-mission-regler-facture] STEP: Configuration de paiement récupérée depuis le store')` |
| `values-prepared` | `console.log('[WORKFLOW.portail-mission-regler-facture] STEP: Variables préparées', values)` |
| `url-replaced` | `console.log('[WORKFLOW.portail-mission-regler-facture] STEP: Variables [[]] remplacées dans le template')` |
| `url-validated` | `console.log('[WORKFLOW.portail-mission-regler-facture] STEP: URL de paiement validée avec new URL()')` |
| `state-updated` | `console.log('[WORKFLOW.portail-mission-regler-facture] STATE: loading=false, error=null')` |
| `end` | `console.log('[WORKFLOW.portail-mission-regler-facture] SUCCESS: Redirection vers', paymentUrl)` |
| `error` | `console.error('[WORKFLOW.portail-mission-regler-facture] ERROR:', error.message)` |
