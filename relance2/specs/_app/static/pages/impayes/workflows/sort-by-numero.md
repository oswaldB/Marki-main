...
|------------|------------------------|
| `start` | `console.log('[WORKFLOW.impayes-sort-by-numero] START: Tri par numéro de facture demandé', {column})` |
| `sort-applied` | `console.log('[WORKFLOW.impayes-sort-by-numero] STEP: Tri appliqué', {sortColumn, sortDirection})` |
| `page-reset` | `console.log('[WORKFLOW.impayes-sort-by-numero] STEP: currentPage réinitialisée à 1')` |
| `api-requested` | `console.log('[WORKFLOW.impayes-sort-by-numero] STEP: Requête API émise', {url, params})` |
| `api-responded` | `console.log('[WORKFLOW.impayes-sort-by-numero] DATA: Réponse API reçue', {count, total})` |
| `table-rerendered` | `console.log('[WORKFLOW.impayes-sort-by-numero] STEP: Tableau ré-affiché avec données triées', {impayes})` |
| `end` | `console.log('[WORKFLOW.impayes-sort-by-numero] SUCCESS: Tri effectué en', duree, 'ms')` |
| `error` | `console.error('[WORKFLOW.impayes-sort-by-numero] ERROR:', error)` |
