...
```
Tu es un expert en relance d'impayés. Génère un email avec ses 4 scénarios.
...
applyGeneratedEmail() {
  ...
  Alpine.store('ui').addToast('Email généré avec ses 4 scénarios', 'success');
}
...
|------------|------------------------|
| `start` | `console.log('[WORKFLOW.sequences-relance-detail-open-ia-modal] START: Ouverture modale IA pour email idx =', idx)` |
| `modal-shown` | `console.log('[WORKFLOW.sequences-relance-detail-open-ia-modal] STEP: showIaModal = true, iaStep =', iaStep)` |
| `step-transition` | `console.log('[WORKFLOW.sequences-relance-detail-open-ia-modal] STEP: iaStep transitioned to', iaStep)` |
| `yaml-validated` | `console.log('[WORKFLOW.sequences-relance-detail-open-ia-modal] DATA: YAML validé, scénarios =', parsedYaml?.email?.scenarios?.length)` |
| `applied` | `console.log('[WORKFLOW.sequences-relance-detail-open-ia-modal] STEP: sequence.emails[idx] remplacé, hasChanges = true')` |
| `end` | `console.log('[WORKFLOW.sequences-relance-detail-open-ia-modal] SUCCESS: Modale IA fermée en', duree, 'ms')` |
| `error` | `console.error('[WORKFLOW.sequences-relance-detail-open-ia-modal] ERROR:', error)` |
