...
|------------|------------------------|
| `start` | `console.log('[WORKFLOW.sequences-relance-detail-sauvegarder] START: Sauvegarde de la séquence', sequence.id)` |
| `validation` | `console.log('[WORKFLOW.sequences-relance-detail-sauvegarder] STEP: Validation des données', { nom, validationObligatoire, emailsCount, reglesAttribution })` |
| `api-call` | `console.log('[WORKFLOW.sequences-relance-detail-sauvegarder] API: PUT /api/sequences/' + sequence.id, payload)` |
| `state-updated` | `console.log('[WORKFLOW.sequences-relance-detail-sauvegarder] STEP: hasChanges = false, saving = false')` |
| `end` | `console.log('[WORKFLOW.sequences-relance-detail-sauvegarder] SUCCESS: Séquence sauvegardée en', duree, 'ms', response.message)` |
| `error` | `console.error('[WORKFLOW.sequences-relance-detail-sauvegarder] ERROR:', error)` |
