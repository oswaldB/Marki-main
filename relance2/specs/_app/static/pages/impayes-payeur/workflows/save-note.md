...
|------------|------------------------|
| `start` | `console.log('[WORKFLOW.impayes-payeur-save-note] START: Sauvegarde note pour payeur', payeurId)` |
| `validation` | `console.log('[WORKFLOW.impayes-payeur-save-note] STEP: Validation contenu note (length:', content.length, ')')` |
| `note-created` | `console.log('[WORKFLOW.impayes-payeur-save-note] STEP: Note créée avec id', newNote.id, 'auteur:', newNote.created_by_name)` |
| `api-call` | `console.log('[WORKFLOW.impayes-payeur-save-note] API: PUT /api/contacts/', payeurId, 'payload (', updatedNotes.length, 'notes)')` |
| `api-response` | `console.log('[WORKFLOW.impayes-payeur-save-note] API: Response status', response.status, 'success:', data.success)` |
| `state-updated` | `console.log('[WORKFLOW.impayes-payeur-save-note] DATA: État après sauvegarde:', { payeurId, totalNotes: updatedNotes.length, updatedAt: data.data.updated_at })` |
| `modal-closed` | `console.log('[WORKFLOW.impayes-payeur-save-note] STEP: showNoteModal = false, noteContent vidé')` |
| `end` | `console.log('[WORKFLOW.impayes-payeur-save-note] SUCCESS: Note ajoutée en', duree, 'ms')` |
| `error` | `console.error('[WORKFLOW.impayes-payeur-save-note] ERROR:', error.message)` |
