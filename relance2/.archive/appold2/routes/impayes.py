...
def list_impayes():
    ...
    for row in rows:
        ...
        # Mapping montant_ttc vers montant_total pour compatibilité frontend
        if 'montant_ttc' in impaye and 'montant_total' not in impaye:
            impaye['montant_total'] = impaye['montant_ttc']
