...
def step_6_check_workflow_tests(cell_path: Path, cell_name: str, dev_plan: dict, specs_path: Path = None) -> tuple[bool, list[str]]:
    ...
    tests_dir = specs_path / "tests-workflows"
